...
import com.cpd.model.AnoLetivoModel;
...
public class DlnController {
	...
	public void salvarEscola(@ModelAttribute("Escola") EscolaModel escolaModel) {
		...
		//Debug.Print(lotacaoRepository.searchLotacao(escolaModel.getDiretorId(), fId1));
	...
	public String loadAnoLetivo(){
	    return "ano_letivo";
	}
	
	@PostMapping(value="/anoletivo")	
	@ResponseBody
	public String saveAnoLetivo(@ModelAttribute("AnoLetivo") AnoLetivoModel anoLetivoModel){
	    return "ano_letivo";
	}
