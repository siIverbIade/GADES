...
$(document).ready(function () {
	   $('#selanoletivo').change(function (event) {
	        ...
	        if (event.target.value === "") {
	        	$(".propano").prop("hidden", true);
	        }
	        else {
	        	$(".propano").prop("hidden", false);
	        	graphql.request(uri, '{obterAnoLetivo(nome: ' + event.target.value + ') {turnos}}').then(function (data) {
	                $.each(data.obterAnoLetivo.turnos, function (i, turno) {
	                	$("#"+turno).prop("checked", true);
	                	
	                });
	            });
	            
	        	graphql.request(uri, '{obterAnoLetivo(nome: ' + event.target.value + ') {semanas}}').then(function (data) {
	                $.each(data.obterAnoLetivo.semanas, function (i, semana) {
	            ...
	            graphql.request(uri, '{obterAnoLetivo(nome: ' + event.target.value + ') {segmentos {id nome}}}').then(function (data) {
	                $.each(data.obterAnoLetivo.segmentos, function (i, segmento) {
	                	$('#segmentos').append($('<div><label><input class="checksegmentos" type="text" value="'+ segmento.nome +'" id="'+ segmento.nome +'"></label></div>'));
	                });
	            });
	        }
	        ;
